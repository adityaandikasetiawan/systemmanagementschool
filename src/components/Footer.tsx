      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-400 text-sm">Jl. Pendidikan Islam No. 123, Jakarta Selatan</span>
              </li>
          ...
          <div>
            ...
            <div className="mt-6">
              <p className="text-gray-400 text-sm mb-2">Newsletter</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">© 2025 Yayasan Baituljannah. All rights reserved.</p>
