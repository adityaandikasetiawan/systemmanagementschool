...
const emailTemplates = {
  ...
  contactMessageNotification: (data) => `
    <!DOCTYPE html>
    <html>
    <head>
      <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background: #1E4AB8; color: white; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <div class="field"><span class="label">Nama:</span> ${data.name}</div>
          <div class="field"><span class="label">Email:</span> ${data.email}</div>
          <div class="field"><span class="label">Telepon:</span> ${data.phone}</div>
          <div class="field"><span class="label">Unit Tujuan:</span> ${data.unit_sekolah}</div>
          <div class="field"><span class="label">Subjek:</span> ${data.subject}</div>
          <hr>
          <div class="field">
          ...
          <hr>
          <p style="font-size: 12px; color: #888;">Email ini dikirim otomatis dari sistem website Yayasan Baituljannah.</p>
        </div>
      </div>
    </body>
    </html>
