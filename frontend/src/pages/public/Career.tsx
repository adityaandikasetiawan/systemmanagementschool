...
export const Career: React.FC<CareerProps> = ({ onNavigate = () => { } }) => {
  ...
  // Default hardcoded jobs as fallback
  const defaultJobs = [
    {
      id: 1,
      ...
      requirements: ['Pendidikan minimal S1 Pendidikan Bahasa Arab', 'Menguasai bahasa Arab aktif dan pasif', 'Berpengalaman mengajar minimal 2 tahun'],
    ...
    },
    {
      ...
      requirements: ['Pendidikan minimal S1 Pendidikan Matematika', 'Menguasai metode pembelajaran aktif'],
                ...
                {[1, 2, 3].map((step) => (
                  <div key={step} className="flex items-center flex-1">
                    <div className="flex items-center gap-2 flex-1">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${applicationStep >= step
                      ...
                      {step < 3 && (
                        <div className={`h-1 flex-1 transition-all duration-300 ${applicationStep > step ? 'bg-white' : 'bg-white/20'
                          }`}></div>
                      )}
                    </div>
                  </div>
