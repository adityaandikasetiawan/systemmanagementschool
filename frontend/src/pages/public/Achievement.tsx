...
// Default hardcoded achievements as fallback
    ...
    (async () => {
      try {
        ...
        if (res.success && res.data && res.data.length > 0) {
          // Filter only published achievements
          const published = res.data.filter((a: any) => a.status === 'published');
          setAchievements(published.length > 0 ? published : defaultAchievements);
        }
      } catch (err) {
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 lg:pb-0 w-full lg:w-auto">
              <button
                ...
                className={`px-4 py-2 rounded-xl whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${selectedYear === 'Semua'
              ...
              {years.map((year) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl whitespace-nowrap transition-all duration-300 ${selectedYear === year
                    ? 'bg-gradient-to-r from-blue-500 to-cyan-600 text-white shadow-lg'
                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                    }`}
                >
            ...
            {categories.map((cat, index) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${selectedCategory === cat.name
                ...
                >
                  ...
                  <span>{cat.name}</span>
                  <span className={`px-2 py-0.5 rounded-full text-xs ${selectedCategory === cat.name ? 'bg-white/30' : 'bg-gray-200'
                    }`}>
                    {cat.count}
                  </span>
                </button>
