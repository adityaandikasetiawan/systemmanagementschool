...
export const Contact: React.FC<ContactProps> = ({ onNavigate = () => {} }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: t('home.units.items.slbit', 'SLBIT Baituljannah'), href: '#', onClick: () => onNavigate('slbit'), image: '/images/logo/logo-slb.png' }
      ]
    },
    {
  ...
  const contactInfo = [
    {
      ...
      details: [
        'Jl. Pramuka No.43, Kemiling Permai',
        'Kec. Kemiling, Kota Bandar Lampung, Lampung 35153'
      ],
      color: '#1E4AB8'
    },
    {
      ...
      details: ['(0721) 271 385', 'WA: 082378537170'],
      color: '#10B981'
    },
    {
      icon: Mail,
      title: t('contact.info.email', 'Email'),
      details: ['admyysn.baituljannah@gmail.com'],
      color: '#F97316'
    },
    {
      icon: Clock,
  ...
  const units = [
    { name: t('home.units.items.tkit', 'TKIT Baituljannah'), phone: '(0721) 271 385', email: 'admyysn.baituljannah@gmail.com' },
    { name: t('home.units.items.sdit', 'SDIT Baituljannah'), phone: '(0721) 271 385', email: 'admyysn.baituljannah@gmail.com' },
    { name: t('home.units.items.smpit', 'SMPIT Baituljannah'), phone: '(0721) 271 385', email: 'admyysn.baituljannah@gmail.com' },
    { name: t('home.units.items.smait', 'SMAIT Baituljannah'), phone: '(0721) 271 385', email: 'admyysn.baituljannah@gmail.com' },
    { name: t('home.units.items.slbit', 'SLBIT Baituljannah'), phone: '(0721) 271 385', email: 'admyysn.baituljannah@gmail.com' }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.message || 'Terjadi kesalahan saat mengirim pesan. Silakan coba lagi.');
    } finally {
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className={`btn-primary bg-[var(--color-primary)] text-white w-full flex items-center justify-center gap-2 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                >
                  <Send className="w-5 h-5" />
                  {isSubmitting ? 'Mengirim...' : t('contact.form.submit', 'Kirim Pesan')}
                </button>
              </form>
            </div>
