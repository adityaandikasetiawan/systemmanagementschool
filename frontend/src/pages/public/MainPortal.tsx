...
import { BookOpen, Users, Award, Globe, Heart, Star, ArrowRight, Sparkles, Trophy, GraduationCap, Target, TrendingUp, Search, Play, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const MainPortal: React.FC<MainPortalProps> = ({ onNavigate }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      href: '#',
      submenu: [
        { label: t('home.units.items.tkit', 'TKIT Baituljannah'), href: '#', onClick: () => onNavigate('tkit'), image: '/images/logo/logo-tkit.png' },
        { label: t('home.units.items.sdit', 'SDIT Baituljannah'), href: '#', onClick: () => onNavigate('sdit'), image: '/images/logo/logo-sdit.png' },
        { label: t('home.units.items.smpit', 'SMPIT Baituljannah'), href: '#', onClick: () => onNavigate('smpit'), image: '/images/logo/logo-smpit.png' },
        { label: t('home.units.items.smait', 'SMAIT Baituljannah'), href: '#', onClick: () => onNavigate('smait'), image: '/images/logo/logo-smait.png' },
        { label: t('home.units.items.slbit', 'SLBIT Baituljannah'), href: '#', onClick: () => onNavigate('slbit'), image: '/images/logo/logo-slbit.png' }
      ]
    },
    {
  ...
  return (
    ...
    >
      ...
      <section className="py-12 md:py-20 px-4 md:px-8 lg:px-16 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #5B4DB5 0%, #7C6FCC 100%)' }}>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-8 lg:gap-8 max-w-6xl mx-auto mb-12">
      ...
      <section className="py-12 md:py-20 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl mb-6">{t('home.video.title', 'Mengenal Lebih Dekat Baitul Jannah')}</h2>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-gray-800">
              <div className="aspect-video relative">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/EMSGkb_-ATI?si=vzJ_huIlUwaheIjn"
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl mb-4">{t('home.why_choose_us.title', 'Mengapa Memilih Baituljannah?')}</h2>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl lg:text-4xl">{t('home.news.title', 'Berita Dan Kegiatan Sekolah')}</h2>
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 to-white">
        <div className="container-custom">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-4xl lg:text-5xl mb-4">{t('home.achievement.title', 'Siswa Berprestasi')}</h2>
          ...
          <div className="relative group px-4 md:px-12">
            <div className="overflow-hidden" ref={emblaRef}>
              <div className="flex -ml-4 md:-ml-8">
                {achievements.map((item, index) => (
                  <div key={index} className="flex-[0_0_100%] md:flex-[0_0_50%] lg:flex-[0_0_33.33%] min-w-0 pl-4 md:pl-8 py-4">
            ...
            {/* Navigation Buttons */}
            <button
              className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 md:translate-x-0 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-[#1E4AB8] hover:bg-[#1E4AB8] hover:text-white transition-all z-10 opacity-0 group-hover:opacity-100"
              onClick={scrollPrev}
            >
              <ChevronLeft className="w-6 h-6" />
            </button>
            <button
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 md:translate-x-0 w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center text-[#1E4AB8] hover:bg-[#1E4AB8] hover:text-white transition-all z-10 opacity-0 group-hover:opacity-100"
              onClick={scrollNext}
            >
            ...
            <div className="flex items-center justify-center gap-2 mt-8">
              {achievements.map((_, index) => (
                <button
                  key={index}
                  className={`h-1 rounded-full transition-all ${index === selectedIndex ? 'w-12 bg-[#1E4AB8]' : 'w-8 bg-gray-300 hover:bg-gray-400'}`}
      ...
      <section className="section-padding bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50">
        <div className="container-custom">
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-strong p-6 md:p-12 mb-12 overflow-hidden">
            <h3 className="text-2xl md:text-4xl text-center mb-10 font-serif text-gray-900">
              {t('home.alumni.title', 'They Made It! Our Alumni in Top Universities')}
            </h3>

            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-10 items-center justify-items-center">
              {[
                { name: 'IPB', src: '/images/university/IPB.png' },
                { name: 'UGM', src: '/images/university/UGM.webp' },
                { name: 'UI', src: '/images/university/UI.png' },
                { name: 'ITB', src: '/images/university/ITB.png' },
                { name: 'UNILA', src: '/images/university/UNILA.png' },
                { name: 'UPI', src: '/images/university/UPI.png' },
                { name: 'UB', src: '/images/university/UB.webp' },
                { name: 'UNAIR', src: '/images/university/UNAIR.png' },
                { name: 'UIN', src: '/images/university/UIN.png' },
                { name: 'Telkom', src: '/images/university/Telkom.png' },
                { name: 'UNPAD', src: '/images/university/UNPAD.webp' },
                { name: 'UNDIP', src: '/images/university/UNDIP.png' },
                { name: 'ITS', src: '/images/university/ITS.png' },
                { name: 'UNS', src: '/images/university/UNS.png' },
                { name: 'UPN', src: '/images/university/UPN.png' },
                { name: 'UNNES', src: '/images/university/UNES.png' },
                { name: 'BINUS', src: '/images/university/BINUS.png' },
              ].map((uni, idx) => (
                <div key={idx} className="group w-20 h-20 md:w-24 md:h-24 flex items-center justify-center p-2 transition-all duration-300 hover:scale-110 grayscale hover:grayscale-0 opacity-80 hover:opacity-100">
                  <img 
                    src={uni.src} 
                    alt={uni.name} 
                    className="w-full h-full object-contain drop-shadow-sm group-hover:drop-shadow-md"
                    title={uni.name}
                  />
                </div>
              ))}
