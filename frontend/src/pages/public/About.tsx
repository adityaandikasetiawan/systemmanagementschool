        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 rounded-full text-sm mb-6">
              ...
              <span>{t('about.leadership.badge', 'Pimpinan')}</span>
            </div>
            <h2 className="text-4xl lg:text-5xl mb-4 text-gray-900">{t('about.leadership.title', 'Jajaran Pimpinan')}</h2>
            <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
              {t('about.leadership.subtitle', 'Para pemimpin visioner yang berdedikasi untuk memajukan pendidikan Islam')}
            </p>
          </div>
