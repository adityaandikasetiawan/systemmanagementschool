        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => onNavigate('about')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
                  {t('site.footer.links.about', 'Tentang Kami')}
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('programs')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
                  {t('site.footer.links.programs', 'Program')}
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('news')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
                  {t('site.footer.links.news', 'Berita')}
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('gallery')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
                  {t('site.footer.links.gallery', 'Galeri')}
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('career')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
                  {t('site.footer.links.career', 'Karir')}
                </button>
              </li>
              <li>
                <button onClick={() => onNavigate('admission')} className="text-gray-400 hover:text-white transition-colors text-left py-1 w-full md:w-auto">
