...
INSERT IGNORE INTO school_units (code, name, level, description, accent_color, icon, address, phone, email, website, principal_name, status, established_year) VALUES
...
INSERT IGNORE INTO academic_years (name, start_date, end_date, semester, is_active) VALUES
...
-- Password: Admin123!
INSERT IGNORE INTO users (username, email, password_hash, role, status, email_verified, last_login) VALUES
...
INSERT IGNORE INTO user_profiles (user_id, full_name, phone, address, city, province, gender, photo_url) VALUES
...
INSERT IGNORE INTO users (username, email, password_hash, role, status, email_verified) VALUES
...
INSERT IGNORE INTO user_profiles (user_id, full_name, phone, address, city, province, gender) VALUES
...
INSERT IGNORE INTO user_profiles (user_id, full_name, phone, address, city, province, birth_date, birth_place, gender) VALUES
...
INSERT IGNORE INTO teachers (user_id, school_unit_id, nip, join_date, status, position, specialization, education_level, certification) VALUES
...
INSERT IGNORE INTO classes (school_unit_id, academic_year_id, name, level, homeroom_teacher_id, capacity, current_students, status) VALUES
-- SDIT Classes
...
INSERT IGNORE INTO subjects (school_unit_id, code, name, description, credit_hours, category, status) VALUES
-- SDIT Subjects
...
INSERT IGNORE INTO students (user_id, school_unit_id, class_id, nis, nisn, enrollment_date, status) VALUES
...
INSERT IGNORE INTO parents (user_id, father_name, father_occupation, father_phone, mother_name, mother_occupation, mother_phone) VALUES
...
INSERT IGNORE INTO student_parents (student_id, parent_id, relation, is_primary) VALUES
(1, 1, 'father', TRUE),
(2, 2, 'father', TRUE),
(3, 3, 'father', TRUE);
...
INSERT IGNORE INTO payment_categories (school_unit_id, name, description, amount, frequency, is_mandatory, status) VALUES
-- SDIT
...
INSERT IGNORE INTO books (school_unit_id, isbn, title, author, publisher, publication_year, category, pages, stock, available, location, status) VALUES
...
INSERT IGNORE INTO news (school_unit_id, title, slug, excerpt, content, author_id, category, is_featured, status, published_at) VALUES
...
INSERT IGNORE INTO achievements (school_unit_id, title, description, category, level, rank, student_name, teacher_name, achievement_date, status) VALUES
...
INSERT IGNORE INTO programs (school_unit_id, title, slug, description, icon, category, status) VALUES
...
INSERT IGNORE INTO settings (`key`, value, description, category, is_public) VALUES
